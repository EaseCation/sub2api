...
func RegisterGatewayRoutes(
	...
	var guardConfig config.OpenAIAccountAvailabilityGuardConfig
	if cfg != nil {
	...
	gateway.Use(openAIAccountAvailabilityGuard)
	...
	gemini.Use(openAIAccountAvailabilityGuard)
	...
	codexDirect.Use(openAIAccountAvailabilityGuard)
	{
	...
	// Antigravity 模型列表
	r.GET("/antigravity/models", gin.HandlerFunc(apiKeyAuth), openAIAccountAvailabilityGuard, requireGroupAnthropic, h.Gateway.AntigravityModels)
	...
	antigravityV1.Use(openAIAccountAvailabilityGuard)
	...
	antigravityV1Beta.Use(openAIAccountAvailabilityGuard)
