export default {
  ...
  payment: {
    ...
    errors: {
      ...
      ALIPAY_CONFIG_INVALID_AUTH_MODE: 'Alipay authentication mode must be public key or public key certificates.',
      ALIPAY_CONFIG_MISSING_CERT: 'Alipay certificate mode requires {key}.',
      ALIPAY_CONFIG_INVALID_CERT: 'Alipay {key} is invalid. Paste the complete certificate PEM content in the correct field; the root bundle must include an RSA root.',
      ALIPAY_CONFIG_INVALID_PRIVATE_KEY: 'Alipay application private key is invalid. Use the complete RSA PKCS#1 or PKCS#8 private key.',
      ALIPAY_CONFIG_CERT_KEY_MISMATCH: 'The Alipay application certificate does not match the application private key.',
