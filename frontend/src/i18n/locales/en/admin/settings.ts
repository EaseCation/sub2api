export default {
    settings: {
      ...
      payment: {
        ...
        field_authMode: 'Authentication mode',
        alipayAuthModePublicKey: 'Public key',
        alipayAuthModeCertificate: 'Public key certificates',
        alipayAuthModeHint: 'Match the signing mode configured for this App ID in Alipay Open Platform. Both modes use your application private key.',
        field_alipayPublicKey: 'Alipay public key',
        field_appCertPublicKey: 'Application public key certificate',
        field_alipayCertPublicKey: 'Alipay public key certificate',
        field_alipayRootCert: 'Alipay root certificates',
        alipayAppCertHint: 'Paste the complete appCertPublicKey_*.crt PEM content. It must match the application private key.',
        alipayPublicCertHint: 'Paste the complete alipayCertPublicKey_RSA2.crt PEM content, including any appended certificate chain.',
        alipayRootCertHint: 'Paste the entire alipayRootCert.crt file, including all BEGIN/END CERTIFICATE blocks.',
