export default {
    settings: {
      ...
      payment: {
        ...
        field_authMode: '接口加签方式',
        alipayAuthModePublicKey: '普通公钥',
        alipayAuthModeCertificate: '公钥证书',
        alipayAuthModeHint: '与支付宝开放平台此 App ID 的接口加签方式保持一致。两种模式均使用应用私钥。',
        field_alipayPublicKey: '支付宝公钥',
        field_appCertPublicKey: '应用公钥证书',
        field_alipayCertPublicKey: '支付宝公钥证书',
        field_alipayRootCert: '支付宝根证书',
        alipayAppCertHint: '粘贴 appCertPublicKey_*.crt 的完整 PEM 内容，证书必须与应用私钥配对。',
        alipayPublicCertHint: '粘贴 alipayCertPublicKey_RSA2.crt 的完整 PEM 内容，保留文件中附带的证书链。',
        alipayRootCertHint: '粘贴 alipayRootCert.crt 的全部内容，保留所有 BEGIN/END CERTIFICATE 段。',
        field_privateKey: '私钥',
        field_publicKey: '公钥',
